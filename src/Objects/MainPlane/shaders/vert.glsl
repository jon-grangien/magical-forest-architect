...
void main() {
  ...
  elevation += 0.5/2.0*(snoise((position*4.0*2.0))-0.5);
  elevation += 0.5/4.0*(snoise((position*4.0*4.0))-0.5);
  elevation += 0.5/8.0*(snoise((position*4.0*8.0))-0.5);
  elevation += 0.5/16.0*(snoise((position*4.0*16.0))-0.5);
  elevation += 0.5/32.0*(snoise((position*4.0*32.0))-0.5);
  elevation += 0.5/64.0*(snoise((position*4.0*64.0))-0.5);
  elevation += 0.5/128.0*(snoise((position*4.0*128.0))-0.5);

  vec3 variedpos = position + 0.01 * normal * 50.0 * elevation;
  variedpos.z += 12000.0 * smoothstep(0.1, 25.0, variedpos.z);
