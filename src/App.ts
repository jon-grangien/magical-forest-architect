...
class App {
  ...
  render() {
    ...
    this.sun.getMesh().position.x += 0.09 * Math.sin(0.08 * Uniforms.Instance.uniforms.u_time.value)
    Uniforms.Instance.uniforms.u_sunLightPos.value = this.sun.getMesh().position
