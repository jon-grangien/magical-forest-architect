...
vec3 c_base = vec3(0.3, 0.4, 0.6);
vec3 c_accent = vec3(0.5, 0.6, 0.7);
float freq = 10.0;
...
void main() {
    ...
    float sin_variation = sin(0.03 * u_time) + small_noise;
    float cos_variation = cos(0.01 * u_time) - small_noise;
    ...
    vec3 out_color = mix(c_accent, c_base, smoothstep(0.0, 0.9, noise));
